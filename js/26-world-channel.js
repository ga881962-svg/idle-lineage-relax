...
function _wcDynamicTopic(q) {
    ...
    if (item && sourceAsked && (!sameMobItemName || mobDropAsked) && !/龍之鑽石|龍鑽|贊助鑽石|贊助鑽/.test(q)) return { key: 'item-source', gen: function () { return _wcItemSourceAnswers(item.id); } };
...
const WC_TOPICS = [
    ...
    {
        key: 'blackmarket', kw: ['黑市', '潘朵拉', '贊助鑽', '贊助鑽石', '龍鑽', '龍之鑽石', '收購', '鑽收', '金幣收購', '收購NPC', '叫賣NPC', '未知遺物', '搜索遺物', '喊收', '吵死了', '驅離', '出價太低', '低價'],
        gen: function () {
            return [
