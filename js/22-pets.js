...
function renderPetStorageNPC(div, confirmUid) {
    ...
    let rows = list.map(p => {
        ...
        let thumb = (typeof monsterAnimPath === 'function' ? monsterAnimPath(p.form) : (typeof assetUrl === 'function' ? assetUrl('assets/anim/' + encodeURIComponent(p.form) + '/') : ('assets/anim/' + encodeURIComponent(p.form) + '/'))) + 'd6/idle_0.png';
...
function _pet8Probe(form, dir) {
    ...
    let folder = (typeof monsterAnimPath === 'function' ? monsterAnimPath(form) : (typeof assetUrl === 'function' ? assetUrl('assets/anim/' + encodeURIComponent(form) + '/') : ('assets/anim/' + encodeURIComponent(form) + '/'))) + 'd' + dir + '/';
    let out = { shadow: {} };
