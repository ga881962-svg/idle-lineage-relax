...
(function (global) {
    ...
    const STAGES = [
        { id:'kent_outer_line', name:'城外戰線', map:'siege_v2_kent_outer', mapName:'肯特城外戰線', type:'kill', target:50, poolId:'kent_standard_guards', slots:5, bg:encodedAreaBg('肯特外門區') },
        { id:'kent_gate_battle', name:'正門攻堅', map:'siege_v2_kent_gate', mapName:'肯特城正門', type:'target', target:1, unitId:'kent_gate_v2', slots:1, bg:encodedAreaBg('肯特') },
        { id:'kent_tower_guard', name:'守護塔防衛線', map:'siege_v2_kent_tower_guard', mapName:'肯特守護塔防衛線', type:'kill', target:50, poolId:'kent_standard_guards', slots:5, bg:encodedAreaBg('肯特外門區') },
        { id:'kent_tower_battle', name:'守護塔決戰', map:'siege_v2_kent_tower', mapName:'肯特守護塔', type:'target', target:1, unitId:'kent_tower_v2', slots:1, bg:encodedAreaBg('肯特內城') },
        { id:'kent_lord_battle', name:'城主決戰', map:'siege_v2_kent_lord', mapName:'肯特內城', type:'target', target:1, unitId:'castle_lord_kent', slots:1, bg:encodedAreaBg('肯特內城') }
    ];
